...
public class DuplicateLead {
	...
	public static void main(String[] args) {
      ...
      WebElement Duplicatecompanyname = driver.findElement(By.name("companyName")) ;
      Duplicatecompanyname.clear();
      Duplicatecompanyname.sendKeys("Testcompany");
      WebElement Duplicatefirstname =driver.findElement(By.id("createLeadForm_firstName"));
      Duplicatefirstname.clear();
      Duplicatefirstname.sendKeys("Priyanka123");
